...
{
    //generics
    public static final SDNutrition STARCAUGHT_FILLET = new SDNutrition().nutrition(1);
    public static final SDNutrition HOSOMAKI = new SDNutrition().nutrition(4);
    public static final SDNutrition TEMAKI = new SDNutrition().nutrition(4);
    public static final SDNutrition URAMAKI = new SDNutrition().nutrition(4);
    public static final SDNutrition NIGIRI = new SDNutrition().nutrition(4);
    public static final SDNutrition HEALTH_FISH_OMELETTE = new SDNutrition().nutrition(6);
    public static final SDNutrition FISH_SALAD = new SDNutrition().nutrition(5);
    public static final SDNutrition FISH_AND_CHIPS = new SDNutrition().nutrition(8);
    ...
    public FoodItem.OnEat onEat = (s, l, e) -> null;
